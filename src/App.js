...
const LoginPage = ({ onLogin, onAdminLogin, onSwitchToRegister, setPage }) => {
    ...
    return (
        <>
            {/* Modal de Admin (Design "Clean" mantido) */}
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 p-8 rounded-2xl shadow-2xl animate-surgir">
                        ...
                        <div className="text-center mb-8 animate-surgir" style={{ animationDelay: '100ms' }}>
                            <img 
                                src="/logo-smartfridge.png" // Caminho direto para a pasta /public
                                alt="SmartFridge Logo" 
                ...
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="cursor-pointer" onClick={() => setPage('home')}>
                            <img src="/logo-smartfridge.png" alt="SmartFridge Logo" className="h-8 w-auto" />
                        </div>
                    </div>
