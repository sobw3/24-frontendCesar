                ...
                return (
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="h-72 overflow-y-auto pr-2 text-sm text-gray-400 space-y-4 custom-scrollbar">
                            <p>Bem-vindo ao Daniel Marques Market. Ao utilizar nossas máquinas autônomas, você concorda com as regras de compra, pagamento, retirada e monitoramento descritas abaixo.</p>
                            ...
                            <p>Em caso de cobrança aprovada sem liberação, produto indisponível ou divergência na retirada, o cliente deve acionar o suporte com comprovante e informações do pedido para análise.</p>
                        </div>
                    </div>
                );
            case 'privacidade':
            ...
            <div className="container mx-auto px-6 md:px-12 py-16 relative z-10 animate-surgir">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="flex flex-col gap-6 items-start">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed pr-4">O <span className="text-[#f2bd46] font-bold">Daniel Marques Market</span> leva mercados autônomos 24h para condomínios, empresas e eventos, com compra rápida por QR Code, pagamento no carrinho e liberação automática da máquina.</p>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <ul className="flex flex-col gap-5">
                            <li><a href="tel:+5561992729183" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors group"><div className="bg-[#1a1a1a] p-2 rounded-lg border border-gray-800 group-hover:border-[#f2bd46]/50 group-hover:bg-[#f2bd46]/10 transition-colors"><Phone size={16} className="text-[#f2bd46]" /></div><span className="text-sm font-medium">(61) 99272-9183</span></a></li>
                            <li><a href="mailto:danielmarquesmarket@gmail.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors group"><div className="bg-[#1a1a1a] p-2 rounded-lg border border-gray-800 group-hover:border-[#f2bd46]/50 group-hover:bg-[#f2bd46]/10 transition-colors"><Mail size={16} className="text-[#f2bd46]" /></div><span className="text-sm font-medium">suporte@danielmarques.com</span></a></li>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="bg-gradient-to-br from-[#f2bd46]/10 to-transparent border border-[#f2bd46]/30 p-6 rounded-2xl relative overflow-hidden group hover:border-[#f2bd46]/60 transition-colors duration-300">
                            ...
                            <h4 className="text-white text-lg font-extrabold mb-2 relative z-10">Leve a operação para seu espaço</h4>
                            <p className="text-xs text-gray-300 mb-5 leading-relaxed relative z-10">Leve o Daniel Marques Market para condomínios, empresas e eventos. Uma solução autônoma para vender rápido, operar 24h e reduzir atrito no atendimento.</p>
                            <button onClick={handleFranquiaClick} className="w-full bg-[#f2bd46] text-black font-extrabold py-3 px-4 rounded-xl text-sm flex justify-center items-center gap-2 hover:bg-[#e0af40] shadow-[0_0_15px_rgba(242,189,70,0.3)] hover:shadow-[0_0_25px_rgba(242,189,70,0.6)] transition-all duration-300 transform hover:-translate-y-1 relative z-10"><MessageSquare size={18} /> Quero saber mais</button>
                        </div>
                    </div>
                </div>
                <div className="border-t border-gray-800/80 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <button onClick={() => setShowAdminModal(true)} className="text-[11px] text-gray-700 hover:text-gray-400 transition-colors flex items-center gap-1"><Shield size={12} /> acesso administrativo</button>
                </div>
            </div>
        </footer>
    );
